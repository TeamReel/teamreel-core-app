...
**Location Context**:
- **Before running .kittify/scripts/powershell/create-new-feature.ps1 -Json "$ARGUMENTS"**: You are in the main repository root
- **After running .kittify/scripts/powershell/create-new-feature.ps1 -Json "$ARGUMENTS"**: A new feature worktree is created at `.worktrees/001-feature-name/`

The script handles location setup automatically. You do NOT need to navigate anywhere before running it.

**What .kittify/scripts/powershell/create-new-feature.ps1 -Json "$ARGUMENTS" Provides**:
